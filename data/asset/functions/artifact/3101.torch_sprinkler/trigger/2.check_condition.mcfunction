#> asset:artifact/3101.torch_sprinkler/trigger/2.check_condition
#
# 神器の発動条件をチェックします
#
# @within function asset:artifact/3101.torch_sprinkler/trigger/1.trigger
...
# CanUsedタグをチェックして3.main.mcfunctionを実行する
    function asset:artifact/3101.torch_sprinkler/trigger/3.main
